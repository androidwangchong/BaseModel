...
object SPUtils {
     ...
     * @param object
     */
    fun put(context: Context, key: String, defaultObject:  Any) {
        ...
        if (defaultObject is String) {
            editor.putString(key, defaultObject)
        } else if (defaultObject is Int) {
            editor.putInt(key,defaultObject)
        } else if (defaultObject is Boolean) {
            editor.putBoolean(key, defaultObject)
        } else if (defaultObject is Float) {
            editor.putFloat(key, defaultObject)
        } else if (defaultObject is Long) {
            editor.putLong(key, defaultObject)
        } else {
