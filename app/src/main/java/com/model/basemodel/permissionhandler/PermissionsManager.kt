 ...
 */
package com.model.basemodel.permissionhandler
...
class PermissionsManager private constructor() {
    ...
    private val mPendingActions = ArrayList<PermissionsResultAction>(1)
        ...
        if (packageInfo != null) {
            ...
            if (permissions != null) {
                for (perm in permissions) {
                    ...
                    if (perm == Manifest.permission.WRITE_SETTINGS || perm == Manifest.permission.MOUNT_UNMOUNT_FILESYSTEMS || perm == Manifest.permission.SYSTEM_ALERT_WINDOW || perm == Manifest.permission.SYSTEM_ALERT_WINDOW) {
                        continue
                    }
                    list.add(perm)
                }
