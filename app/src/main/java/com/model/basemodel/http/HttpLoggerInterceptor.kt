 ...
 */
class HttpLoggerInterceptor @JvmOverloads constructor(private val logger: Logger = HttpLoggerInterceptor.Logger.DEFAULT) : Interceptor {
...
//                    com.orhanobut.logger.Logger.d(message)
    ...
    fun setLevel(level: Level?): HttpLoggerInterceptor {
